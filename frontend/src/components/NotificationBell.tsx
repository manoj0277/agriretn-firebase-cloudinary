        ...
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-neutral-800 rounded-lg shadow-xl border border-neutral-200 dark:border-neutral-700 z-50">
                    <div className="p-3 border-b dark:border-neutral-700 font-semibold text-neutral-800 dark:text-neutral-100">{t('notificationsTitle')}</div>
                    <div className="max-h-96 overflow-y-auto hide-scrollbar">
                        {notifications.length > 0 ? (
                            ...
                            <p className="text-center text-neutral-700 dark:text-neutral-300 p-4">{t('noNewNotifications')}</p>
                        )}
                    </div>
                </div>
            )}
