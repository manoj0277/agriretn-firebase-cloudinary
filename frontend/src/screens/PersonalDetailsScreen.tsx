  ...
  const DetailItem: React.FC<{ k: string; label: string; value?: string | number }> = ({ k, label, value }) => (
    <div className="py-3 flex items-start justify-between gap-3">
      <div className="flex-1">
        ...
        <p className="text-neutral-800 dark:text-neutral-100">{value || t('notSet') || 'Not set'}</p>
      </div>
    </div>
  );
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="relative">
            ...
            <button
              ...
              className="absolute -bottom-1 -right-1 p-2 rounded-full bg-white border border-neutral-200 shadow hover:bg-neutral-100"
