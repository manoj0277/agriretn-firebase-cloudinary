...
export const users: User[] = [
    ...
    { id: 5, name: 'Priya Patel', email: 'farmer2@test.com', password: 'password123', phone: '6543210987', role: UserRole.Farmer, status: 'approved', locationCoords: { lat: 18.56, lng: 73.93 }, profilePicture: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=256&auto=format&fit=crop' },
];
