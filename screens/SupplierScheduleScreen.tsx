        ...
        <div className="p-4">
            <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg border border-neutral-200 dark:border-neutral-600">
                <div className="flex justify-between items-center mb-4">
                    <button onClick={() => changeMonth(-1)} className="p-2 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-600 text-neutral-800 dark:text-neutral-200">&lt;</button>
                    <h2 className="font-bold text-lg text-neutral-800 dark:text-neutral-100">
                        {currentDate.toLocaleString('default', { month: 'long', year: 'numeric' })}
                    </h2>
                    <button onClick={() => changeMonth(1)} className="p-2 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-600 text-neutral-800 dark:text-neutral-200">&gt;</button>
                </div>
                <div className="grid grid-cols-7 gap-1 text-center text-sm font-semibold text-neutral-800 dark:text-neutral-300 mb-2">
                ...
                <div className="grid grid-cols-7 gap-1">
                    {calendarData.map((day, index) => {
                        ...
                        if (isBooked) {
                            ...
                            classes += "bg-neutral-200 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100 relative";
                        } else {
                            classes += "bg-neutral-100 text-neutral-800 dark:bg-neutral-600 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-500";
                        }
                ...
                <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-sm text-neutral-800 dark:text-neutral-200">
                    ...
                    <div className="flex items-center"><span className="w-4 h-4 rounded-full bg-neutral-100 dark:bg-neutral-600 border border-neutral-300 dark:border-neutral-500 mr-2"></span>Available</div>
                </div>
            </div>
        </div>
    );
