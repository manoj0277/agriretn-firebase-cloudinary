    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen p-6 text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-neutral-400 mb-8">
                {isPaidNow
                    ? "Your booking is confirmed and fully paid. No further action is needed after the work is complete."
                    : "You've chosen to pay later. Payment will be due after the work is completed."}
            </p>
