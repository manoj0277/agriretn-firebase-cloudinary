...
const NotificationBell: React.FC = () => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button onClick={handleToggle} className="relative p-2 text-white hover:text-neutral-200 rounded-full hover:bg-green-600 transition-colors">
                    ...
                    <div className="max-h-96 overflow-y-auto hide-scrollbar">
                        {notifications.length > 0 ? (
                            [...notifications].reverse().map(n => (
                                <div
                                    key={n.id}
                                    className={`p-3 border-l-4 ${!n.read ? 'bg-gray-200 dark:bg-neutral-700/50' : ''} ${getTypeClasses(n.category)} relative group`}
