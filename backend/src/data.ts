...
export let users: User[] = [
    { id: '1', name: 'Ravi Kumar', email: 'farmer@test.com', password: 'manoj123', phone: '9876543210', role: UserRole.Farmer, userStatus: 'approved', avgRating: 4.8, locationCoords: { lat: 17.3850, lng: 78.4867 }, profilePicture: 'https://images.unsplash.com/photo-1591181825852-f4a45a6c3a81?q=80&w=800&auto=format&fit=crop' },
    { id: '2', name: 'Laxmi Services', email: 'supplier@test.com', password: 'manoj123', phone: '8765432109', role: UserRole.Supplier, userStatus: 'approved', locationCoords: { lat: 17.393, lng: 78.486 }, profilePicture: 'https://images.unsplash.com/photo-1562235392-56b5791742de?q=80&w=800&auto=format&fit=crop' },
    { id: '3', name: 'Admin User', email: 'admin@test.com', password: 'manoj123', phone: '1234567890', role: UserRole.Admin, userStatus: 'approved', profilePicture: 'https://images.unsplash.com/photo-1580852300654-034f8007104b?q=80&w=800&auto=format&fit=crop', locationCoords: { lat: 17.38, lng: 78.49 } },
    { id: '4', name: 'Suresh Farms', email: 'supplier2@test.com', password: 'password123', phone: '7654321098', role: UserRole.Supplier, userStatus: 'pending', profilePicture: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?q=80&w=800&auto=format&fit=crop', locationCoords: { lat: 17.45, lng: 78.55 } },
    { id: '5', name: 'Priya Patel', email: 'farmer2@test.com', password: 'password123', phone: '6543210987', role: UserRole.Farmer, userStatus: 'approved', locationCoords: { lat: 17.41, lng: 78.50 }, profilePicture: 'https://images.unsplash.com/photo-1601758123926-4cf339f4c278?q=80&w=800&auto=format&fit=crop' },
];
